...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'CronTabManager',
                'description' => 'Default source for files of CronTabManager',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/crontabmanager/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'crontabmanager_source_default'))) {
